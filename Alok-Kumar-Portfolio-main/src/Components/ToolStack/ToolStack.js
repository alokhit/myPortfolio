...
function ToolStack() {
  return ( 
     <div>
      ...
      <h1 style={{ fontSize: "2.6em",  textAlign: "center" , marginTop:'20px' }}>
    <span className="purple">Tools</span> 
    </h1>
        
   
    <Row style={{ justifyContent: "center", paddingBottom: "50px",  border: "5px solid #fca61f", borderRadius: "0 25px", paddingTop: "20px", boxShadow: '1px 2px 9px #ffff' }}>
